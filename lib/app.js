...
app.get('/nasa', async(req, res) => {
  ...
  try {
    ...
    res.json({
      status: 404,
      responseText: 'This resource was not found',
    });
  }
});
...
app.get('/api/location/:city', async(req, res) => {
  ...
  try {
    ...
    res.json({
      status: 400,
      responseText: 'You are missing vital credentials',
    });
  }
});
...
app.get('/api/saved-locations', async(req, res) => {
  ...
  try {
    ...
    res.json({
      status: 401,
      responseText: 'You need to log in to view this',
    });
  }
});
...
app.delete('/api/saved-locations/:id', async(req, res) => {
  ...
  try {
    ...
    res.json({
      status: 401,
      responseText: 'You need to log in to take this action',
    });
  }
});
...
app.post('/api/notes', async(req, res) => {
  ...
  `, [req.userId, req.body.lat, req.body.lon, req.body.city, req.body.date, req.body.title, req.body.body, req.body.wish]);
    ...
    res.json({
      status: 401,
      responseText: 'You need to log in to make this action',
    });
  }
});
